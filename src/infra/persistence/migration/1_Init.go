...
import (
	...
	"go-web-api/config"
	"go-web-api/constant"
	models "go-web-api/domain/model"
...
func createTables(database *gorm.DB) {
	// Ensure uuid-ossp extension is enabled for UUID primary keys
	...
	// Booking
	tables = addNewTable(database, models.Booking{}, tables)
	tables = addNewTable(database, models.Ticket{}, tables)
